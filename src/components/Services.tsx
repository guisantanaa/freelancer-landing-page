...
const Services = () => {
  return (
    <section className="py-20" id="Serviços">
      <div className="text-center">
        <h2 className="font-bold text-3xl text-textColor-300 mb-5">Serviços</h2>
      ...
      <div className="flex gap-5 m-12 max-[768px]:flex-col max-[768px]:m-3">
        <div className="border rounded-md bg-green-300 shadow-xl text-center h-[22rem]">
          <img className="m-auto py-8" src={pilates} alt="icone pilates" />
          <h3 className="font-bold text-2xl py-2">Pilates</h3>
          <p className="m-2">
        ...
        <div className="border rounded-md b bg-green-300 shadow-xl text-center h-[22rem]">
