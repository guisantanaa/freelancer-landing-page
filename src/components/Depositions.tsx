...
const Depositions = () => {
  ...
  return (
    <section id="Depoimentos">
      <div className="text-center mt-20 py-8 w-96 m-auto max-[440px]:w-auto">
        <h2 className="text-3xl font-bold text-green-300 max-[440px]:text-2xl max-[440px]:m-3">
      ...
      <div>
        <ul className="flex gap-5 m-12 max-[834px]:flex-col max-[440px]:m-3 mt-0">
          <li className="w-auto h-64 shadow rounded-md max-[440px]:h-80">
